...
//
// firefox/filesystem.js - Utilities for working with nsIFile and related 
// interfaces.
...
G_File.__defineGetter__("LINE_END_CHAR", function() {
  var end_char;
  // In FF 1.5 and later, we can avoid loading the HTTP protocol handler, which
  // at startup triggers the "http-startup" event.
